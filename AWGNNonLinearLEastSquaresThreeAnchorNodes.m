...
%Non-linear LeastSquares Ten Iterations with 3 Anchor Nodes and Additive
...
for i=1:3
 ...
 fprintf('Iteration with Additive White Gaussian Noise with zero mean and 0.02 standard devition Number, 3 Anchor Nodes = %d\n',k)
